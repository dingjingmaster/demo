...
PROTOBUF_NAMESPACE_OPEN
template<> ::test1::Response* Arena::CreateMaybeMessage<::test1::Response>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace test1 {
...
class Response final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:test1.Response) */ {
 public:
