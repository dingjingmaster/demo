/*************************************************************************
> FileName: glib-gobject.c
> Author  : DingJing
> Mail    : dingjing@live.cn
> Created Time: Fri 13 Jan 2023 09:17:04 AM CST
 ************************************************************************/
...
static inline gpointer test_object_get_instance_private (TestObject *self)
{
...
static GType test_object_get_type (void)
{
    ...
    if (!test_object_type) {
        ...
        TestObject_private_offset = g_type_add_instance_private (test_object_type, sizeof (TestObjectPrivate));
    }
...
static inline gpointer derived_object_get_instance_private (DerivedObject *self)
{
...
static GType derived_object_get_type (void)
{
    ...
    if (!derived_object_type) {
        ...
        DerivedObject_private_offset = g_type_add_instance_private (derived_object_type, sizeof (DerivedObjectPrivate));
    }
...
static void test_gobject_basics (void)
{
    GTypeInfo info = { 0, };
